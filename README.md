Clone the repo create a virtual environment using thi command "python -m venv venv" . \venv\Scripts\activate (for windows) source venv/bin/activate (for mac/linux)
